...
## Voorbereiding
Om direct aan de gang te kunnen gaan tijdens de workshop sessies is het belangrijk dat je R op je computer installeert. Dit is [downloadsite](http://cran.xl-mirror.nl/) voor R. Zie [hier](https://youtu.be/cX532N_XLIs?list=PLqzoL9-eJTNBDdKgJgJzaQcY6OXmsXAHU) voor instructies (Engels).
...
Om echter wat comfortabeler te programmeren zijn er zogenaamde *integrated development environments (IDEs)* ontwikkeld. Wij gaan werken met die van [RStudio](https://cloud.r-project.org/). Ook deze software is gratis te [downloaden](https://www.rstudio.com/products/rstudio/download/#download).
...
<!-- BubbleChart generated in R 3.4.3 by googleVis 0.6.2 package -->
<!-- Thu Mar 29 09:56:50 2018 -->
...
// jsData 
function gvisDataBubbleChartID4a1e6d189720 () {
...
// jsDrawChart
function drawChartBubbleChartID4a1e6d189720() {
var data = gvisDataBubbleChartID4a1e6d189720();
var options = {};
...
options["height"] = 700;
    ...
    document.getElementById('BubbleChartID4a1e6d189720')
    );
...
callbacks.push(drawChartBubbleChartID4a1e6d189720);
})();
function displayChartBubbleChartID4a1e6d189720() {
  var pkgs = window.__gvisPackages = window.__gvisPackages || [];
  var callbacks = window.__gvisCallbacks = window.__gvisCallbacks || [];
...
<!-- jsChart -->  
<script type="text/javascript" src="https://www.google.com/jsapi?callback=displayChartBubbleChartID4a1e6d189720"></script>
 
<!-- divChart -->
  
<div id="BubbleChartID4a1e6d189720" 
